...
public class PhotonCam extends SubsystemBase {
    ...
    public double getYTranslationFromTarget(){
    ...
    public void periodic() {
        SmartDashboard.putNumber("AprilTag yaw ", getCameraYaw());
        SmartDashboard.putNumber("AprilTag y translation (TODO: measure/verify) ", getYTranslationFromTarget());
    }
